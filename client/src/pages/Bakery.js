...
class Bakery extends Component {
  ...
  handleNewSubmit = event => {
    ...
    this.setState({
      customerPhone: "", dateOfPickup: "", valueSize: "", valueFlavor: "", valueOutside: "", valueInside: "",
  ...
  handleCustomerNewSubmit = event => {
    ...
    API.saveCustomer({
      ...
      .then(
        this.setState({ customerName: this.state.newName })
      )
      .then(
        this.setState({ registeredCustomer: true })
      )
      .catch(err => console.log(err));
          ...
          <div className="order2">
            ...
            {!this.state.inputForm ? (
              !this.state.subtotal ? (
                <form>
                  ...
                  <div>
                    {!this.state.registeredCustomer ? (
                      <div>
                        <p>Enter name for unregistered customer</p>
                        <Input
                        ...
                        <div>
                          <p>Order Details</p>
                          <p>Customer: {this.state.customerName ? this.state.customerName : "No selection"}</p>
                          ...
                          <p>Order Entered By: {this.state.employee ? this.state.employee : "No name entered"}</p>
                          <FormBtn
                ...
                <div>
                  <p>Order submitted! Select new order to create another order.</p>
                  <FormBtn
